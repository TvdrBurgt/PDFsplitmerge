...
class GUI(QWidget):
    def __init__(self):
        ...
        button_findpdf.setIcon(QtGui.QIcon("./Icons/ICON_BROWSE.png"))
        
        # Button - load pdf
        button_openpdf = QPushButton(clicked=self.open_file)
        button_openpdf.setIcon(QtGui.QIcon("./Icons/ICON_OPEN.svg"))
        
        # Button - close pdf
        button_closepdf = QPushButton(clicked=self.close_file)
        button_closepdf.setIcon(QtGui.QIcon("./Icons/ICON_DELETE.png"))
    ...
    def close_file(self):
        ...
        self.label_filesindicator.setText("")
    ...
    def split(self):
        ...
        pages = list(map(int, pages_intext.split(",")))
